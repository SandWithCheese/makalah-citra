...
makalah-citra/
├─ data/                    
│  ├─ raw/                 # Raw input seismic images (for tiling)
│  ├─ processed/           # Tiled images ready for annotation
│  ├─ train/               # YOLO training data (generated by train script)
│  ├─ val/                 # YOLO validation data (generated by train script)
│  └─ README.md
│
├─ preprocessing/           # Seismic image preprocessing
│  ├─ seismic_tiler.py     # Tile generator (fixed input/output)
│  └─ README.md
│
├─ runs/                    # YOLO training outputs
│  └─ detect/train/        # Metrics, curves, confusion matrix
│
├─ docs/                    # IEEE LaTeX documentation (academic paper)
├─ src/                     # Source code and helper scripts
│  ├─ train_yolo.py        # Main training script
│  └─ run_train.sh         # Helper script for CUDA environment
│
├─ results/                 # Experimental results and visualizations
├─ data.yaml                # YOLO dataset configuration (auto-generated)
